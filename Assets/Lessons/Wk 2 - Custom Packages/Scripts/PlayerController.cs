...
public class PlayerController : MonoBehaviour
{
    ...
    void Update() {
        ...
        if (controller.isGrounded) 
        {
            ...
            if (Input.GetKeyDown(KeyCode.Space) || inputActions.Movement.Jump.IsPressed())
            {
    ...
    {
        stereoRig.transform.position = new Vector3(transform.position.x, transform.position.y +5.5f,transform.position.z-12);
